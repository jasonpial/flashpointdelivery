...
import { Search, ChevronRight, ArrowRight, Zap, Shield, X, ShoppingBag, Store, ShieldCheck, Truck, MapPin } from 'lucide-react';
  ...
  return (
    <div style={styles.landingContainer} className="slide-up">
      ...
      <section style={styles.heroSliderSection} className="hero-section-box">
        ...
        {/* Invisible logo click zone */}
        <div
          onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
          onMouseEnter={() => setIsLogoHovered(true)}
          onMouseLeave={() => setIsLogoHovered(false)}
          style={{ ...styles.logoOverlayLink, backgroundColor: isLogoHovered ? 'rgba(255,255,255,0.05)' : 'transparent' }}
          title="Flashpoint Deliveries - Home"
        />

        {/* Original track button overlay (interactive hotspot on hero image) */}
        <button
      ...
      <section style={styles.entrySection} className="entry-section-pills">
        <div className="container" style={styles.entryGrid}>
          ...
          >
            ...
            <div style={styles.entryTextCol}>
              <h4 style={styles.entryCardTitle} className="entry-card-title">Become a Seller</h4>
...
if (typeof document !== 'undefined') {
  ...
  styleSheet.innerText = `
    ...
    /* ── Hero image container — full fit without cropping on mobile/tablet ── */
