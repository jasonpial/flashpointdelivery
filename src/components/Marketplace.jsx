...
export default function Marketplace({ products, shops, user, onPurchaseItem, onNavigateToAuth }) {
                ...
                {filteredProducts.map(product => (
                  <div key={product.id} className="card card-hover" style={styles.productCard}>
                    ...
                    <div style={styles.productInfoBox} className="marketplace-product-info-box">
                      ...
                      <button 
                        onClick={() => onPurchaseItem(product)}
                        className="btn btn-primary"
                        style={styles.purchaseBtn}
                      >
                        <Truck size={14} color="#000000" />
                        <span>Purchase & Deliver</span>
                      </button>
                    </div>
...
if (typeof document !== 'undefined') {
  ...
  styleSheet.innerText = `
    @media (max-width: 768px) {
      .marketplace-header-deco { display: none !important; }
