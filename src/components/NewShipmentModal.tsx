                  ...
                  {ITEM_CATEGORIES.map((cat) => (
                    <div key={cat.name} className="border border-white/5 rounded-2xl overflow-hidden">
                      <button 
                        ...
                        className="w-full px-6 py-4 bg-white/5 flex justify-between items-center hover:bg-white/10 transition-colors relative group"
                      >
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 rounded-xl overflow-hidden border border-white/10">
                            <img 
                              src={
                                cat.name === 'Electronics & Gadgets' ? 'https://images.unsplash.com/photo-1498049794561-7780e7231661?q=80&w=100&h=100&auto=format&fit=crop' :
                                cat.name === 'Apparel & Accessories' ? 'https://images.unsplash.com/photo-1523381210434-271e8be1f52b?q=80&w=100&h=100&auto=format&fit=crop' :
                                cat.name === 'Home & Living' ? 'https://images.unsplash.com/photo-1513584684374-8bdb74838a0f?q=80&w=100&h=100&auto=format&fit=crop' :
                                cat.name === 'Food & Beverages' ? 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?q=80&w=100&h=100&auto=format&fit=crop' :
                                cat.name === 'Office & Stationery' ? 'https://images.unsplash.com/photo-1497032628192-86f99bcd76bc?q=80&w=100&h=100&auto=format&fit=crop' :
                                'https://images.unsplash.com/photo-1581094288338-2314dddb7ec4?q=80&w=100&h=100&auto=format&fit=crop'
                              } 
                              alt={cat.name} 
