        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="bg-brand-black-light p-8 rounded-[2rem] border border-white/5 shadow-2xl relative overflow-hidden">
            <div className="absolute inset-0 opacity-[0.02] pointer-events-none">
              <img 
                src="https://images.unsplash.com/photo-1551288049-bbbda5012375?q=80&w=1000&auto=format&fit=crop" 
          ...
          <div className="bg-brand-black-light rounded-[2rem] border border-white/5 overflow-hidden shadow-2xl">
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-white/5">
                    <th className="px-8 py-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">Tracking ID</th>
                    <th className="px-8 py-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">Route</th>
                    <th className="px-8 py-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">Status</th>
                    <th className="px-8 py-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">Handler</th>
                    <th className="px-8 py-4 text-left text-[10px] font-black text-slate-500 uppercase tracking-widest">Action</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-white/5">
                  {filteredShipments.length > 0 ? filteredShipments.map((row, i) => (
                    <tr key={i} className="hover:bg-white/5 transition-colors group">
                      <td className="px-8 py-4 font-black text-sm text-brand-yellow uppercase tracking-widest">{row.trackingNumber}</td>
